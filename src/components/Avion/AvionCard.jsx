  ...
  return (
    <div className="avion-page-container rounded">
      <header className="fleet-header d-flex justify-content-between align-items-center mb-5">
        <div>
          <h1 className="fw-black text-uppercase tracking-tighter">Gestion Flotte</h1>
          <p className="text-secondary">Actuellement {avions.length} appareils en opération active</p>
        </div>
            ...
            <div className="fleet-card-inner">
              ...
              <div className="card-bottom">
                ...
                <div className="card-actions">
                  ...
                  <button className="action-btn circle-btn delete" title="Supprimer">
