    ...
    <div className="container-fluid p-4">
        ...
        <div>
          ...
          <div className="d-flex gap-4 mt-2">
             <div className="stat-simple">
                <span className="text-muted small text-uppercase fw-bold">Total Passagers</span>
                <p className="h4 fw-black mb-0">{passagers.length}</p>
             </div>
             <div className="stat-simple border-start ps-4">
                <span className="text-muted small text-uppercase fw-bold">Nationalités</span>
      ...
      {showAdd && (
        <div className="card shadow-sm mb-5 border-0 animate__animated animate__fadeIn">
          <div className="card-header bg-dark text-white fw-bold">ENREGISTRER UN PASSAGER</div>
          <div className="card-body p-4">
            <form className="row g-3">
              <div className="col-md-4">
                <label className="form-label small fw-bold">NOM</label>
                <input type="text" className="form-control" placeholder="Nom du passager" />
              </div>
              <div className="col-md-4">
              ...
              <div className="col-md-4">
                ...
                <input type="text" className="form-control" placeholder="Ex: Française" />
              </div>
              <div className="col-md-6">
                <label className="form-label small fw-bold">E-MAIL</label>
                <input type="email" className="form-control" placeholder="adresse@mail.com" />
              </div>
              <div className="col-md-4">
                <label className="form-label small fw-bold">TÉLÉPHONE</label>
                <input type="tel" className="form-control" placeholder="+33..." />
              </div>
              <div className="col-md-2 d-flex align-items-end">
                <button type="submit" className="btn btn-success w-100 fw-bold">VALIDER</button>
              </div>
            </form>
          </div>
        </div>
              ...
              {passagers.map((passager) => (
                <tr key={passager.id}>
                  ...
                  <td className="text-center">
                    ...
                    <button className="btn btn-outline-danger btn-sm fw-bold px-3">SUPPRIMER</button>
                  </td>
                </tr>
              ))}
            </tbody>
