...
export default function Login() {
  ...
  const { login: contextLogin, isConnected } = useAuth();
  ...
  // Déjà connecté → rediriger vers l'accueil (après tous les hooks)
  if (isConnected) {
      ...
      <div className="card shadow-lg rounded-4 overflow-hidden" style={{ maxWidth: "900px", width: "100%" }}>
        <div className="row g-0">
          ...
          <div className="col-md-5 bg-dark text-white d-flex flex-column justify-content-center p-5 text-center">
            ...
            <p className="text-muted small mb-4 text-uppercase tracking-widest" style={{ fontSize: "0.7rem" }}>
              L'élite de l'aérien
            </p>
            <button
          ...
          <div className="col-md-7 bg-white p-5">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="btn btn-dark w-100 fw-bold py-3 mt-3 shadow-sm tracking-widest"
              >
